"""
agents/authority_strategy.py

AUTHORITY 暗樁策略實作。

設計原則：
  AuthorityStrategy 以退休法官的專業身份發言，利用身份光環影響陪審團。
  此檔案只包含具體策略，抽象基類 PlantStrategy 定義於 agents/strategies.py。

  未來新增 PeerPressureStrategy、EmotionalStrategy 等策略時，
  仿照此檔案建立獨立模組，不修改 strategies.py。
"""
from __future__ import annotations

from agents.strategies import VERDICT_GUILTY, PlantStrategy
